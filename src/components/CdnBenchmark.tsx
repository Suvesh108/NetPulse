    ...
    <div className="bg-white dark:bg-[#0B1120] rounded-2xl p-4 sm:p-5 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col gap-3 transition-colors">
      ...
      <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-slate-800/80">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-sans font-bold text-xs sm:text-sm text-slate-900 dark:text-slate-100">Multi-Server Edge Benchmark</h3>
            <span className="text-[9px] text-slate-400">Concurrent performance across major cloud networks</span>
          </div>
        </div>
        ...
        >
          {isRunning ? <RotateCcw className="w-3 h-3 animate-spin" /> : <Play className="w-3 h-3 fill-white" />}
